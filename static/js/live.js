...
// On page load, get hostname from URL and connect
window.onload = function () {
    // Get hostname from URL path like /live/hostname/
    const path = window.location.pathname;
    const hostname = path.split('/')[2]; // Gets 'prabhat-Nitro-AN515-57' from '/live/prabhat-Nitro-AN515-57/'
